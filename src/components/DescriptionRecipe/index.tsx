...
const stepsData: Array<StepData> = [
  ...
  {
    title: 'шаг 2',
    description: 'Смешать соевый соус и кетчуп, посыпать измельченным чесноком. Соус поставить в холодильник  ',
  },
  {
    title: 'шаг 3',
    ...
    <div className={styles.modal_dialog} onClick={e => e.stopPropagation()}>
      ...
      <div className={styles.modal_body}>
        <div className={styles.modal_body__left}>
          <img className={styles['modal_body__left-img']} src={img}  alt="price"></img>
          <div>
            <h4 className={styles['modal_body__left-title']}>Ингридиенты:</h4>
            <ul>
              <li>Картофель <span>2кг</span></li>
              <li>Лук эт ми <span>1шт</span></li>
            </ul>
          </div>
          <div>
            <h4 className={styles['modal_body__left-title']}>Время приготовления:</h4>
            <span>~48 минут</span>
          </div>
          <div>
            <h4 className={styles['modal_body__left-title']}>Количество персон:</h4>
            <span>2 персоны</span>
          </div>
          <div>
            <h4 className={styles['modal_body__left-title']}>Разновидность блюда:</h4>
            <span>Веганская пища</span>
          </div>
        </div>
        <div className={styles.modal_body__right}>
          <div className={styles['modal_body__right-title']}>
            <h3>Картофель жареный</h3>
            <PrintIcon />
          </div>
          <div className={styles['modal_body__right-line']}></div>
          <div className={styles['modal_body__right-author']}>
            <span className={styles.author}>Автор: <span>Cooker</span></span>
            <span>ID: <span>id_{idRecipe}</span></span>
          </div>
          <div>
